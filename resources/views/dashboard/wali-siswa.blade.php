<x-app-layout>
    ...
    <style>
        ...
        /* ── Scroll wrapper — hanya aktif di mobile ── */
        ...
        /* lebar minimum agar 12 bulan tidak terlalu rapat di hp */
        .chart-inner-bulanan { min-width: 640px; }

        /* di layar besar tidak perlu scroll */
        ...
        .section-label {
            ...
            color: #4A5E8A; margin-bottom: 0.65rem;
        }
        .trend-badge {
    ...
    (function () {
        ...
        function initCharts() {
            ...
            const c1 = new ApexCharts(bulananEl, {
                ...
                chart: {
                    ...
                    type: 'area',
                    height: 260,
                    // nonaktifkan zoom & pan bawaan ApexCharts agar tidak konflik dengan scroll native
                    zoom:    { enabled: false },
                    pan:     { enabled: false },
                    selection: { enabled: false },
                    events: {
                        // touch pada area chart tidak mengganggu scroll halaman
                        mounted(ctx) {
                            const el = ctx.el;
                            if (!el) return;
                ...
                fill: {
                    type: 'gradient',
                    gradient: { shadeIntensity: 1, opacityFrom: 0.42, opacityTo: 0.02, stops: [0, 90, 100] }
                },
                ...
                markers: {
                    ...
                    strokeWidth: 2.5,
                    hover: { size: mobile ? 6 : 7 }
                },
                xaxis: {
                    categories: _bulananLabels,
                    labels: {
                        style: { fontSize: mobile ? '9px' : '10px', colors: '#718096' },
                        rotate: -40,
                        hideOverlappingLabels: false, // tampilkan semua karena sudah ada scroll
                    },
                ...
                tooltip: {
                    theme: 'light',
                    // tooltip tap-friendly: tetap muncul di tap pertama di mobile
                    shared: true,
                    intersect: false,
            ...
            // tinggi bar menyesuaikan jumlah item agar tidak terlalu rapat di mobile
            const barHeight    = mobile ? '60%' : '55%';
            const barItemHeight = mobile ? 56 : 70;
            ...
            const c2 = new ApexCharts(jenisEl, {
                ...
                chart: {
                    ...baseOpts.chart,
                    type: 'bar',
                    height: Math.max(180, _jenisLabels.length * barItemHeight),
                    zoom:      { enabled: false },
                    selection: { enabled: false },
                },
                ...
                yaxis: {
                    labels: {
                        ...
                        formatter: v => v && v.length > (mobile ? 18 : 24)
                            ? v.substring(0, mobile ? 18 : 24) + '…'
                            : v,
                    },
                },
                tooltip: {
                    ...
                    x: {
                        formatter: (val, { dataPointIndex }) =>
                            `<strong>${_jenisLabels[dataPointIndex] ?? ''}</strong><br>Tingkat: ${_jenisTingkat[dataPointIndex] ?? '-'}`
                    },
        ...
        /* ── Re-render saat resize (portrait ↔ landscape) ── */
        let _resizeTimer;
