<x-app-layout>
    <div class="container mx-auto p-4">
        <h1 class="text-2xl font-bold mb-4">Edit Pelanggaran</h1>
        ...
        <form action="{{ route('pelanggaran.update', $pelanggaran->id_pelanggaran) }}" 
            ...
            {{-- SISWA --}}
            <div>
                <label for="id_siswa" class="block font-medium">Siswa</label>
            ...
            {{-- WALI KELAS --}}
            <div>
                <label for="id_walikelas" class="block font-medium">Wali Kelas</label>
            ...
            {{-- JENIS PELANGGARAN --}}
            <div>
                <label for="id_jenispelanggaran" class="block font-medium">Jenis Pelanggaran</label>
                <select name="id_jenispelanggaran" id="id_jenispelanggaran" class="border rounded w-full px-2 py-1">
            ...
            {{-- WAKTU KEJADIAN --}}
            <div>
                <label for="waktu_kejadian" class="block font-medium">Waktu Kejadian</label>
            ...
            <div>
                ...
                <textarea name="deskripsi" id="deskripsi" class="border rounded w-full px-2 py-1">
            ...
            <div>
                ...
                <a href="{{ route('pelanggaran.index') }}" class="ml-2 text-gray-700 hover:underline">
                    Batal
                </a>
            </div>
        </form>
