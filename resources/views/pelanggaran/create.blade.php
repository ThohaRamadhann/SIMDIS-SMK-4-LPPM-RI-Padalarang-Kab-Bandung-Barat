<x-app-layout>
    ...
    <div class="max-w-5xl mx-auto p-4">
        ...
        <div class="bg-white border border-gray-100 rounded-2xl shadow-sm p-5">
            ...
            <form action="{{ route('pelanggaran.store') }}" method="POST" class="space-y-3">
                @csrf
                ...
                <div>
                    ...
                    <select name="id_siswa"
                        class="mt-0.5 w-full h-10 px-3 text-sm rounded-lg border border-gray-200 bg-gray-50 text-black
                    ...
                    <select name="id_walikelas"
                        ...
                        @foreach($waliKelas as $w)
                            <option value="{{ $w->id_walikelas }}"
                                {{ old('id_walikelas') == $w->id_walikelas ? 'selected' : '' }}>
                ...
                <div>
                    ...
                    <textarea name="deskripsi" rows="4"
                        class="mt-0.5 w-full px-3 py-2 text-sm rounded-lg border border-gray-200 bg-gray-50 text-black
                               focus:bg-white focus:border-[#F5B800] focus:ring-2 focus:ring-[#F5B800]/20 resize-none">{{ old('deskripsi') }}</textarea>
                </div>
                ...
                <div class="flex items-center gap-2 pt-2">
                    ...
                    <a href="{{ route('pelanggaran.index') }}"
                        class="bg-white border border-gray-300 text-gray-600 px-4 py-2 text-sm rounded-lg hover:bg-gray-50 transition">
                        Batal
                    </a>
