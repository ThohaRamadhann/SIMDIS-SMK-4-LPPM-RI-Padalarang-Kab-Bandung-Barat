    ...
    <div x-show="formOpen"
        ...
        <div class="bg-white border border-gray-100 rounded-2xl shadow-sm p-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                ...
                {{-- Nama Wali Kelas — search-as-you-type, tidak load semua data --}}
                        ...
                        <div x-show="open" x-cloak
                            ...
                            @if (strlen($searchPengguna ?? '') < 2)
                                <div class="px-3 py-2 text-xs text-gray-400">Ketik minimal 2 huruf untuk mencari
                                    wali kelas</div>
                            @elseif (($pengguna ?? collect())->isEmpty())
                                <div class="px-3 py-2 text-xs text-gray-400">Wali kelas tidak ditemukan</div>
                            @else
