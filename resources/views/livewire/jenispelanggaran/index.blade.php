<div>
    <style>
        ...
        .jp-btn-primary:hover { transform: translateY(-1px); box-shadow: 0 5px 16px rgba(245,184,0,0.45); }
        ...
        .jp-btn-secondary:hover { background: #F0F4FB; color: #0D2D6B; }
        ...
        .jp-btn-danger:hover { transform: translateY(-1px); }
        ...
        .jp-btn-trash:hover { background: #fee2e2; }
        .jp-btn-trash.active {
            background: #fee2e2;
            color: #991b1b;
            border-color: #f87171;
        ...
        @keyframes jp-fadein { from { opacity:0; transform:translateY(-6px); } to { opacity:1; transform:none; } }
        ...
        .jp-table thead { background: linear-gradient(90deg, #0D2D6B 0%, #163580 100%); }
        .jp-table thead th {
        ...
        .jp-table thead th:first-child { width: 50px; text-align: center; }
        .jp-table thead th:last-child  { text-align: center; width: 120px; }
        .jp-table tbody tr {
            border-bottom: 1px solid #f0f4fb;
            transition: background 0.15s;
        }
        .jp-table tbody tr:last-child { border-bottom: none; }
        .jp-table tbody tr:hover { background: #f7f9fd; }
        .jp-table tbody td {
            padding: 0.85rem 1rem;
            font-size: 0.85rem;
            color: #1e3a6e;
        }
        .jp-table tbody td:first-child { text-align: center; font-weight: 600; color: #4A5E8A; font-size: 0.78rem; }
        .jp-table tbody td:last-child  { text-align: center; }
        ...
        .jp-badge::before { content:''; width:5px; height:5px; border-radius:50%; background:currentColor; }
        .jp-badge-ringan { background:#fef9c3; color:#854d0e; }
        .jp-badge-sedang { background:#fef3c7; color:#b45309; }
        .jp-badge-berat  { background:#fee2e2; color:#991b1b; }

        /* ── Action buttons ── */
        .jp-actions { display: flex; align-items: center; justify-content: center; gap: 0.4rem; }
        .jp-icon-btn {
        ...
        .jp-icon-btn:hover { transform: scale(1.12); }
        .jp-icon-btn.edit    { background: #dbeafe; color: #1d4ed8; }
        .jp-icon-btn.delete  { background: #fee2e2; color: #dc2626; }
        .jp-icon-btn.restore { background: #dcfce7; color: #15803d; }
        .jp-icon-btn.destroy { background: #fee2e2; color: #991b1b; }

        /* ── Empty state ── */
        .jp-empty { text-align: center; padding: 3rem 1rem; color: #4A5E8A; }
        .jp-empty i { font-size: 2.5rem; opacity: 0.3; margin-bottom: 0.75rem; display: block; }
        .jp-empty p { font-size: 0.85rem; margin: 0; }
        ...
        .jp-modal-header.danger { background: linear-gradient(90deg, #991b1b, #dc2626); }
        .jp-modal-header h3 {
        ...
        .jp-modal-close:hover { background: rgba(255,255,255,0.25); }
        .jp-modal-body   { padding: 1.3rem 1.4rem; }
        .jp-modal-footer {
        ...
        /* ── Form ── */
        .jp-form-group { margin-bottom: 1rem; }
        .jp-form-group label {
            display: block; font-size: 0.78rem; font-weight: 600;
            color: #0D2D6B; margin-bottom: 0.4rem; letter-spacing: 0.02em;
        }
        .jp-form-group input,
        ...
        .jp-error { display: block; font-size: 0.75rem; color: #dc2626; margin-top: 0.3rem; }
    ...
    <div class="jp-header">
        <div class="jp-header-title">
            ...
            <p>{{ $showTrash ? 'Data yang dihapus sementara — bisa dipulihkan kapan saja' : 'Kelola daftar jenis dan tingkat pelanggaran siswa' }}</p>
        </div>
        <div class="jp-header-actions">
            ...
            {{-- Tombol Tambah (hanya mode aktif) --}}
            @if (!$showTrash)
    ...
    {{-- Toolbar: Search + Filter + PerPage (hanya mode aktif) --}}
    @if (!$showTrash)
            ...
            <div class="jp-modal">
                ...
                <div class="jp-modal-body">
                    <div class="jp-form-group">
                        ...
                        <input wire:model.live="nama_pelanggaran"
                               type="text"
    ...
    @if ($confirmForceDelete)
        <div class="jp-overlay">
            <div class="jp-modal jp-modal-sm">
                ...
                <div class="jp-modal-body">
                    <p style="font-size:0.88rem; color:#1e3a6e; margin:0;">
                        Yakin ingin menghapus <strong>permanen</strong>? Tindakan ini <strong>tidak bisa dibatalkan</strong>.
                    </p>
