                                    ...
                                    <div class="px-4 sm:px-5 py-4 space-y-3">
                                        ...
                                        <template x-if="activeNotif.nama_siswa">
                                            <div class="bg-[#f0f4fb] rounded-xl p-3 sm:p-4">
                                                <p
                                                    class="text-[11px] font-bold text-[#4A5E8A] uppercase tracking-wide mb-2">
                                                    👤 Informasi Siswa
                                                </p>
                                        ...
                                        <template x-if="activeNotif.nama_pelanggaran">
                                            <div class="rounded-xl p-3 sm:p-4 border"
                                                :style="'background:' + tingkatBg(activeNotif.tingkat) + '; border-color:' +
                                                    tingkatColor(activeNotif.tingkat) + '40'">
                                                ...
                                                <span
                                                    class="inline-flex items-center gap-1 mt-1.5 px-2.5 py-1
                                                             rounded-full text-xs font-bold"
                                                    :style="'background:' + tingkatColor(activeNotif.tingkat) + '20; color:' +
                                                        tingkatColor(activeNotif.tingkat)">
                                                    <span
                                        ...
                                        <template x-if="activeNotif.waktu_kejadian">
                                            <div class="flex items-start gap-3">
                                                <div
                                                    class="w-8 h-8 rounded-lg bg-[#f0f4fb] flex items-center
                                                            justify-center text-sm flex-shrink-0">
                                                    🕐</div>
                                                <div>
                                                    <p
                                                        class="text-[11px] text-[#4A5E8A] font-semibold uppercase tracking-wide">
                                                        Waktu Kejadian
                                                    </p>
                                        ...
                                        <template x-if="activeNotif.status_pembinaan">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <span
                                                        class="inline-flex items-center mt-0.5 px-2.5 py-1
                                                                 rounded-full text-xs font-bold"
                                        ...
                                        <div class="bg-gray-50 rounded-xl p-3 sm:p-4 border border-gray-100">
                                            <p
                                                class="text-[11px] text-[#4A5E8A] font-semibold uppercase tracking-wide mb-1.5">
                                                💬 Pesan Notifikasi
                                            </p>
                                        ...
                                        <template
                                            ...
                                            <div
                                                class="border border-[rgba(13,45,107,0.12)] rounded-xl overflow-hidden">

                                                {{-- Header --}}
                                                <div
                                                    class="bg-[#f0f4fb] px-3 py-2.5 flex items-center gap-2
                                                    ...
                                                    <svg class="w-3.5 h-3.5 text-[#0D2D6B]" fill="none"
                                                        ...
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                            stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0
                                                                 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542
                                                                 7-4.477 0-8.268-2.943-9.542-7z" />
                                                    </svg>
                                                    <p
                                                        class="text-[11px] font-bold text-[#0D2D6B] uppercase tracking-wide">
                                                ...
                                                <div class="divide-y divide-[#f0f4fb]">
                                                    <template x-for="(penerima, idx) in activeNotif.status_penerima"
                                                        :key="idx">
                                                        <div
                                                            class="flex items-center justify-between px-3 py-2.5 bg-white">
