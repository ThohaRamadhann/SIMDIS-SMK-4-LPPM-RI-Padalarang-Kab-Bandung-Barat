...
class Users extends Component
{
    ...
    {
        $query = Pengguna::with('role', 'waliKelas', 'waliSiswa');
    ...
    {
        $u = Pengguna::with(['waliKelas', 'waliSiswa'])->findOrFail($id);
        ...
        if ($u->waliKelas) {
            ...
            $this->hubungan = $u->waliSiswa->hubungan;
        }
    }
