...
class ImportData extends Component
{
    ...
    private function getRequiredColumns(): array
    {
        return match ($this->type) {
            'pengguna'   => ['name', 'username', 'password', 'role'],
            'wali_kelas' => ['username_pengguna', 'jabatan'],
            'wali_siswa' => ['username_pengguna', 'hubungan'],
            'kelas'      => ['nama_kelas', 'tingkat', 'jurusan', 'tahun_ajaran'],
            'siswa'      => ['nama', 'nis', 'username_walisiswa', 'nama_kelas', 'tahun_ajaran'],
            default      => [],
        };
    }
    ...
    private function resolveImporter(): ?object
    {
        return match ($this->type) {
            ...
            'wali_siswa' => new WaliSiswaImport(),
